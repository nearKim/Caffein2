    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.CharField(choices=[('hum', '인문대학'), ('soc', '사회과학대학'), ('nat', '자연과학대학'), ('nur', '간호대학'), ('bus', '경영대학'), ('eng', '공과대학'), ('agr', '농업생명과학대학'), ('art', '미술대학'), ('law', '법과대학'), ('edu', '사범대학'), ('cbe', '생활과학대학'), ('vet', '수의과대학'), ('pha', '약학대학'), ('mus', '음악대학'), ('med', '의과대학'), ('cls', '자유전공학부'), ('int', '국제대학'), ('den', '치의대학'), ('uni', '연합전공'), ('cor', '연계전공')], max_length=3, verbose_name='단과대')),
