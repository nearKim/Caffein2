...
class PartnerMeeting(Instagram):
    ...
    num_coffee = models.SmallIntegerField(_('커모 횟수'), default=0, validators=[meeting_coffee_validator, ])
    num_eat = models.SmallIntegerField(_('밥모 횟수'), default=0, validators=[meeting_eat_validator, ])
