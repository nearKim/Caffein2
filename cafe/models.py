...
class Cafe(TimeStampedMixin):
    ...
    closed_day = models.CharField(_('휴무일'), choices=DAY_CATEGORY, max_length=3, null=True, blank=True)
    closed_frq = models.CharField(_('휴무 빈도'), choices=FRQ_CATEGORY, max_length=6, null=True, blank=True)
